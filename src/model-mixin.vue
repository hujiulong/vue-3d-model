        ...
        updateLights() {
            ...
            this.lights.forEach( item => {
                ...
                if ( type === 'ambient' || type === 'ambientlight' ) {
                    ...
                    const color = item.color === 0 ? item.color : item.color || 0x404040;
                    ...
                    const color = item.color === 0 ? item.color : item.color || 0xffffff;
                    const intensity = item.intensity === 0 ? item.intensity : item.intensity || 1;
                    ...
                    const skyColor = item.skyColor === 0 ? item.skyColor : item.skyColor || 0xffffff;
                    const groundColor = item.groundColor === 0 ? item.groundColor : item.groundColor || 0xffffff;
                    const intensity = item.intensity === 0 ? item.intensity : item.intensity || 1;
